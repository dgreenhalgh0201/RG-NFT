    ...
    images: [
      {
        ...
        path: process.env.PUBLIC_URL + '/images/product.png',
        price: 99.99,
      ...
      },
      {
        ...
        path: process.env.PUBLIC_URL + '/images/product1.png',
        price: 109.99,
      ...
      {
        name: 'Neon Mirage',
        path: process.env.PUBLIC_URL + '/images/product2.png',
        price: 89.99,
      ...
      },
      {
        ...
        path: process.env.PUBLIC_URL + '/images/product3.png',
        price: 94.99,
      ...
      {
        name: 'Virtual Sunset Boulevard',
        path: process.env.PUBLIC_URL + '/images/product4.png',
        price: 119.99,
